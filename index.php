                ...
                <div class="service-wrapper">
                    <div class="service-inner wow fadeInRight" data-wow-delay=".2s">
                        ...
                        <div class="service-box">
                            <h3>My Story</h3>
                            <p>I have been interested in computer technology since high school.
                            After high school, I took a course in the pseudocode and tarbo C programming language.The computer university break out for various reasons and I graduated with a major in mathematics.
                            Did you know that the first computer programming was started in 1843 by the mathematician Ada Lovelace?That knowledge gave me strength and while studying autoit scripting and i test trojan viruses(loikaw), now I do not want to do that anymore, I just want to benefit people.</p><br><br>
                        </div>
                    </div>
                    ...
                    <div class="service-inner wow fadeInRight" data-wow-delay=".8s">
                        ...
                        <div class="service-box">
                            ...
                            <p>I am proficient in graphic design with photoshop and coreldraw. Other design tools include google sketchup and autocad.
                            I can also use Adobe lash creation tool SWiSH Max because I have tried some animations and songs in the adobe flash player. You can also use some scripts and events, and even small swf games.</p>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-7 col-sm-12 pull-right">
                    <div class="profile-desc wow fadeInRight">
                        <h2 class="section-title uppercase">Hello, My Name is Arkar Mann Aung.</h2>
                        <br/>
                        <p>My Story</p>
                        <p style="text-align: justify;">I have been interested in computer technology since high school.
                            After high school, I took a course in the pseudocode and tarbo C programming language.The computer university break out for various reasons and I graduated with a major in mathematics.
                            Did you know that the first computer programming was started in 1843 by the mathematician Ada Lovelace?That knowledge gave me strength and while studying autoit scripting and i test trojan viruses(<a class="text text-danger" href="https://github.com/arkarMannAung/loikaw_virus_code.git">loikaw</a>), now I do not want to do that anymore, I just want to benefit people.
                        </p>
                        <br/>
                        <p>Web Development</p>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 wow fadeInLeft">
                    <div class="skill-desc">
                        <p style="text-align: justify;">&ensp;&ensp;&ensp;&ensp;&ensp;I am using Bootstrap Framework. It make me faster and easier include  HTML and CSS based design templates for typography, forms, buttons, tables, navigation, modals, image carousels, etc.</p>
                        <p style="text-align: justify;">&ensp;&ensp;&ensp;&ensp;&ensp;I am using  jQuery for client-side scripting of HTML.This library is built on shorter, simpler code, after all. With simple syntax and open coding standards, developers can shorten the time it takes to deploy an application or site.</p>
                        <p style="text-align: justify;">&ensp;&ensp;&ensp;&ensp;&ensp;I am using Laravel is a php framework for creating web applications with an easy to use syntax. The idea behind Laravel is that it makes common development tasks easy such as routing, authentication, sessions, and caching.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-sm-6 wow fadeInRight" >
                    ...
                    <div class="skill-box wow fadeInDown" data-wow-delay=".4s">
                        ...
                        <div class="progress">
                            <div class="progress-bar" role="progress-bar" aria-valuemin="0" aria-valuenow="70" aria-valuemax="100" style="width: 75%;" >
                                75%
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="skill-box wow fadeInDown" data-wow-delay=".8s">
                        <label> JAVA</label>
                        <div class="progress">
                            <div class="progress-bar" role="progress-bar" aria-valuemin="0" aria-valuenow="85" aria-valuemax="100" style="width: 65%;" >
                                65%
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
        ...
        <article class="timeline-entry">
            ...
            <div class="timeline-entry-inner">
                ...
                <div class="timeline-label">
                    <h3 class="resume-title">Bachelor of Science in Mathematics</h3>  
                    <p>I graduated in 2011 with bsc maths. Since the first year, i was learn about logical, which is very interesting. Math matters for computer science because it teaches students how to use abstract language, work with algorithms, self-analyze their computational thinking, and accurately modeling real-world solutions.<a href="images/BSC-math.pdf">See-Certificate</a></p>
                </div>
            </div>
        ...
        <article class="timeline-entry">
            ...
            <div class="timeline-entry-inner">
                ...
                <div class="timeline-label">
                   <h3 class="resume-title">level 3 Technician Diploma in construction</h3>
                     <p>Following the accreditation of the Technician IVQs in Construction(6165)
        ...
        <article class="timeline-entry">
            ...
            <div class="timeline-entry-inner">
                ...
                <div class="timeline-label">
                    <h3 class="resume-title">Level 5 Advanced Technician Diploma in Civil Engineering</h3>
                    <p>The Level 5 Advanced Technician Diplomas in Civil Engineering focus on
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4">
                    <div class="portfolio-box">                     
                        <img src="images/portfolio/panel1.jpg" alt="" class="img-responsive">
                        
                        <div class="image-overlay text-center">
                            <a href="https://erpsoftware.arkarmannaung.me">

                                <span>ERP App For Garment<br>with Laravel</span>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="portfolio-box">                     
                        <img src="images/portfolio/panel3.jpg" alt="" class="img-responsive">
                        
                        <div class="image-overlay text-center">
                            <a href="https://ecommerce.arkarmannaung.me">

                                <span>Ecommerce Project<br>with Laravel</span>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="portfolio-box">                     
                        <img src="images/portfolio/portfolio_pj1.jpg" alt="" class="img-responsive">
                        
                        <div class="image-overlay text-center">
                            <a href="https://onlineshop.arkarmannaung.me">

                                <span>Online Shop Project <br>PHP/JS/Sql</span>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="portfolio-box">
                        <img src="images/portfolio/vueJs.jpg" alt="" class="img-responsive">
                        <div class="image-overlay text-center">
                            <a href="https://vueapplication.arkarmannaung.me">
                                <span>Vue 3 Application<br>with tailwindcss</span>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="portfolio-box">
                        ...
                        <div class="image-overlay text-center">
                            <a href="https://animate.arkarmannaung.me">
                                <span>My animate Test<br>Pure js/maths trigo</span>
                            </a>
                        </div>
                    </div>
                </div> <!-- col-md-4 end -->
<!--                <div class="col-md-4 col-sm-4">
                    <div class="portfolio-box">
                        <img src="images/portfolio/portfolio_pj2.jpg" alt="" class="img-responsive">
                        <div class="image-overlay text-center">
                            <a href="https://myshoptest.arkarmannaung.me">
                                <span>Tea Shop Project <br>CSS/Bootstrap 4</span>
                            </a>
                        </div>
                    </div>
                </div> -->
...
<!--                        <p>Lorem ipsum dolor sit amet, ea doming epicuri iudicabit nam, te usu virtute placerat. Purto brute disputando cu est, eam dicam soluta ei. Vel dicam vivendo accusata ei.</p> -->
                        ...
                        <ul>
                            <li><span>Email :</span> <a>mr.arkarmannaung@gmail.com</a></li>
                            <li><span>Phone :</span> <a>+959-780-132-792</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <ul class="socail-link list-inline">
                        ...
                        <li><a href="https://www.facebook.com/arkarmannaung"><i class="fa fa-facebook"></i></a></li> 
